...
public class Outils {
	...
	public static class MyRandom extends Random {
        ...
        public int valeur(int i, int j) {
			if (i > j) {
				throw new IllegalArgumentException("The lower bound must be less than or equal to the upper bound.");
			}
			return nextInt(j - i + 1) + i; // Generates a random number between i and j (inclusive)
		}
